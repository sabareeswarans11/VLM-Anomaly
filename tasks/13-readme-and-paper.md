# Task 13 — README + Paper Draft

Tell the story: *"Did VLMs kill anomaly detection — and can they run in
your pocket?"*
...
A reader who never used the repo can read the README and understand the
result. A reviewer can run one command and get the same plots.
